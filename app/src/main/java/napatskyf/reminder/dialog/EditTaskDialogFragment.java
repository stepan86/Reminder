...
/**
 * Created by SERVER 1C 8 hlib on 10.11.2016.
 */

public class EditTaskDialogFragment extends DialogFragment {
    onEditTaskListener onEditTaskListener;
    ...
    public interface onEditTaskListener {
        void onTaskListner(ModelTask task);
    }

    public  void setClickListener(Activity clicklistener ) {
        onEditTaskListener = (onEditTaskListener) clicklistener;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Spinner spPriority = (Spinner) container.findViewById(R.id.spinerPriority);
        ...
        etDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DialogFragment datePickerFragment = new DatePickerFragmant() {
                    @Override
        ...
        builder.setPositiveButton(R.string.dialog_ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                task.setmTitle(etTitle.getText().toString());
                task.setStatus(ModelTask.STATUS_CURRENT);
                if (etDate.length() != 0 || etTime.length() != 0) {
                    task.setDate(calendar.getTimeInMillis());
                }
                task.setStatus(ModelTask.STATUS_CURRENT);
                onEditTaskListener.onTaskListner(task);
                dialog.dismiss();
            }
        });
